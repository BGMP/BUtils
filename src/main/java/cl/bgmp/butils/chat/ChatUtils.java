...
/**
 * @author
 *     https://github.com/PGMDev/PGM/blob/dev/util/src/main/java/tc/oc/pgm/util/LegacyFormatUtils.java
 */
public final class ChatUtils {
  ...
  public static String underline(String str) {
    return applyFormat(UNDERLINE, str);
  }
  ...
  public static String strikethrough(String str) {
    return applyFormat(STRIKETHROUGH, str);
  }
  ...
  public static boolean isFormat(ChatColor color) {
    return BOLD.equals(color)
        || ITALIC.equals(color)
        || UNDERLINE.equals(color)
        || STRIKETHROUGH.equals(color)
        || MAGIC.equals(color);
  }
